//*****************************************************************************
// MK65F18 startup code for use with MCUXpresso IDE
//
// Version : 180919
//*****************************************************************************
//
...
// Todd Morton, 10/16/2018 Changed last word from 0xFFFFFFFE to 0xFFFFFBFE in
//                         order to disable the NMI out of reset. This is needed
//                         because it is connected to SW2 (PTA4).
//*****************************************************************************
...
void ResetISR(void) {
    ...
    (void)__bss_section_table;  //This does not appear to be used so explicitly say so.
